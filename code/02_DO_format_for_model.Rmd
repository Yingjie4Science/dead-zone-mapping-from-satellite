...
### write to file ---------------------------
fname <- paste0(dirname(dir), '/data/data_for_gee/_for_sam/sample_2014_DO_plusBathymetry.xlsx'); fname
writexl::write_xlsx(x = df2014, path = fname)

fname <- paste0(dirname(dir), '/data/data_for_gee/_for_sam/sample_2014_locations.csv'); fname
# writexl::write_xlsx(x = df2014_pt, path = fname)
write.csv(x = df2014_pt, file = fname, row.names = F)

fname <- paste0(dirname(dir), '/data/data_for_gee/_for_sam/sample_2014_locations.shp'); fname
...
do %>%
  ggplot()+
  geom_point(aes(x = DO, y = -Depth, color = Temp), show.legend = F) +
  facet_wrap(~Date) +
