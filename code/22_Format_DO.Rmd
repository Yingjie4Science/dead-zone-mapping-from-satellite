...
dir.path   <- paste0(dir.root, '/data/DO/DO_GOM/DO_Integrated_Matli_NCSU')
...
```{r - Fig 1. Samples by year & by source}
...
pname <- paste0(dir.fig, 'sample_num_bySource_DZT.png'); pname
ggsave(filename = pname, plot = last_plot(), width = 7, height = 5, units = 'in', dpi = 300) ## bg = "transparent",
```



```{r - Fig S1. Sample map by year}
